...
if __FILE__ == $0
	...
	options    = {
		...
		"matching_method" => "approximate",   # Text annotation strategy (approximate string matching).
		"min_tokens"      => 2,               # Minimum number of tokens for annotation. 
		"max_tokens"      => 8,               # Maximum number of tokens for annotation.
		"threshold"       => 0.6,             # The threshold for approximate string matching.
		"top_n"           => 5,               # The maximum number of annotations per each text span. (0 means all)
		}
	uri        = "http://localhost:3000/dictionaries/EntrezGene%20-%20Homo%20Sapiens"
