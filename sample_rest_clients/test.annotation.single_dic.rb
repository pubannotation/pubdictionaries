...
#
#   To get the URI of a specific dictionary and annotation 
# options, please see the dictionary page and click the "Get
# Annotator URI" button.
#
################################################################
...
#                             (e.g., http://localhost:3000/dictionaries/EntrezGene%20-%20Homo%20Sapiens/text_annotation?matching_method=approximate&max_tokens=6&min_tokens=1&threshold=0.6&top_n=0)
